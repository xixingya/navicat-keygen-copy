...
可以看我博客上面更通俗易懂的教程，为了不更改原文，我把链接贴在这里 https://www.yuque.com/docs/share/d827f860-db6b-45b1-bd50-efb319792da4?# 《mac激活navicat premium 12(附下载链接)》
...
* Clone `mac` 分支，并编译keygen和patcher
  ...
  ```bash
  $ git clone -b mac --single-branch https://github.com/xixingya/navicat-keygen.git
  $ cd navicat-keygen
  $ make all
  ```
